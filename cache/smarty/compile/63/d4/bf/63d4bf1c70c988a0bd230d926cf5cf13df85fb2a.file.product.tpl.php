<?php /* Smarty version Smarty-3.1.19, created on 2015-08-04 09:52:33
         compiled from "/var/www/html/paintings.loc/themes/paintings/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:191889246855c07d51728c96-61594100%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '63d4bf1c70c988a0bd230d926cf5cf13df85fb2a' => 
    array (
      0 => '/var/www/html/paintings.loc/themes/paintings/product.tpl',
      1 => 1438606134,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '191889246855c07d51728c96-61594100',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55c07d52081237_11174982',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55c07d52081237_11174982')) {function content_55c07d52081237_11174982($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/paintings.loc/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_modifier_replace')) include '/var/www/html/paintings.loc/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_math')) include '/var/www/html/paintings.loc/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/var/www/html/paintings.loc/tools/smarty/plugins/function.counter.php';
?>
    ...
    <div itemscope itemtype="http://schema.org/Product">
        <div class="primary_block row">
            ...
            <div class="product-pagination">
                <div class="artist_painting_cutted">
...
">
                ...
                <div class="previous_link">
                    <?php if ($_smarty_tpl->tpl_vars['prev_product']->value) {?>
                        <a title="<?php echo $_smarty_tpl->tpl_vars['prev_product']->value['name'];?>
" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['prev_product']->value['id_product'],$_smarty_tpl->tpl_vars['prev_product']->value['link_rewrite']);?>
">« <?php echo smartyTranslate(array('s'=>'Previous Product'),$_smarty_tpl);?>
</a>
                    <?php }?>
                </div>
                <div class="next_link">
                    <?php if ($_smarty_tpl->tpl_vars['next_product']->value) {?>
                        <a title="<?php echo $_smarty_tpl->tpl_vars['next_product']->value['name'];?>
" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['next_product']->value['id_product'],$_smarty_tpl->tpl_vars['next_product']->value['link_rewrite']);?>
"><?php echo smartyTranslate(array('s'=>'Next Product'),$_smarty_tpl);?>
 »</a>
                    <?php }?>
                </div>
                <div class="related_artists">
                    <?php if (!empty($_smarty_tpl->tpl_vars['related_artists']->value)) {?>
                        <a id="related_button" href="#"><?php echo smartyTranslate(array('s'=>'Show related artists'),$_smarty_tpl);?>
 »</a>
                        <ul id="related_list">
                            <?php  $_smarty_tpl->tpl_vars['artist'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['artist']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['related_artists']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['artist']->key => $_smarty_tpl->tpl_vars['artist']->value) {
$_smarty_tpl->tpl_vars['artist']->_loop = true;
?>
                                <li>
                                    <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getCategoryLink($_smarty_tpl->tpl_vars['artist']->value['id_category'],$_smarty_tpl->tpl_vars['artist']->value['link_rewrite']), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['artist']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
">
...
" name="lnk_view" class="exclusive"/>
            ...
            <?php }?>
            <!-- left infos-->
            <div class="pb-left-column col-xs-12 col-sm-4 col-md-5 col-md-offset-2">
                <!-- product img-->
...
<?php }?>"
                               rel="gal1"
                               href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'thickbox_default'), ENT_QUOTES, 'UTF-8', true);?>
"
                               itemprop="url">
                                <img itemprop="image"
...
-default-large_default.jpg" id="bigpic"
                             alt="" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
" width="<?php echo $_smarty_tpl->tpl_vars['largeSize']->value['width'];?>
"
                             height="<?php echo $_smarty_tpl->tpl_vars['largeSize']->value['height'];?>
"/>
...
" data-fancybox-group="other-views" class="fancybox<?php if ($_smarty_tpl->tpl_vars['image']->value['id_image']==$_smarty_tpl->tpl_vars['cover']->value['id_image']) {?> shown<?php }?>"<?php }?>
...
" data-id="resetImages">
                ...
                <?php if (($_smarty_tpl->tpl_vars['display_qties']->value==1&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&$_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value&&$_smarty_tpl->tpl_vars['product']->value->available_for_order)) {?>
                    ...
                    <p id="pQuantityAvailable"<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0) {?> style="display: none;"<?php }?>>
                        ...
                        <span <?php if ($_smarty_tpl->tpl_vars['product']->value->quantity>1) {?> style="display: none;"<?php }?>
                                id="quantityAvailableTxt"><?php echo smartyTranslate(array('s'=>'Item'),$_smarty_tpl);?>
</span>
                        <span <?php if ($_smarty_tpl->tpl_vars['product']->value->quantity==1) {?> style="display: none;"<?php }?>
                                id="quantityAvailableTxtMultiple"><?php echo smartyTranslate(array('s'=>'Items'),$_smarty_tpl);?>
</span>
                    </p>
                <?php }?>
                ...
                <?php if (isset($_smarty_tpl->tpl_vars['meta_keywords']->value)&&$_smarty_tpl->tpl_vars['meta_keywords']->value) {?>
                    <div class="product-keywords">
                        <span>Keywords - </span>
                        <?php $_smarty_tpl->tpl_vars["keywords_array"] = new Smarty_variable(explode(",",$_smarty_tpl->tpl_vars['meta_keywords']->value), null, 0);?>
 ...
 $_from = $_smarty_tpl->tpl_vars['keywords_array']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
$_smarty_tpl->tpl_vars['keyword']->_loop = true;
 $_smarty_tpl->tpl_vars['number']->value = $_smarty_tpl->tpl_vars['keyword']->key;
?>
                            <?php if (count($_smarty_tpl->tpl_vars['keywords_array']->value)!=$_smarty_tpl->tpl_vars['number']->value+1) {?>
                                <a href="<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
search?controller=search&search_query=<?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['keyword']->value,' ','');?>
"><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['keyword']->value,' ','');?>
</a>,
                            <?php } else { ?>
                                <a href="<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
search?controller=search&search_query=<?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['keyword']->value,' ','');?>
"><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['keyword']->value,' ','');?>
                ...
                <div class="author_description_container">
                    <img class="replace-2x" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getCatImageLink($_smarty_tpl->tpl_vars['category']->value->link_rewrite,$_smarty_tpl->tpl_vars['category']->value->id_image,'medium_default'), ENT_QUOTES, 'UTF-8', true);?>
...
">
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['category']->value->description)&&$_smarty_tpl->tpl_vars['category']->value->description) {?>
                        <p class="author_description">
                            <?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['category']->value->description);?>

                        </p>
                    <?php }?>
                </div>
                <?php if (isset($_smarty_tpl->tpl_vars['category']->value->description)&&$_smarty_tpl->tpl_vars['category']->value->description) {?>
                    <p class="painting_description">
                        <span>Additional Information</span> -
                        <?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product']->value->description);?>
            ...
            <div class="pb-right-column col-xs-12 col-sm-4 col-md-3">
                <?php if (($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value))||isset($_smarty_tpl->tpl_vars['groups']->value)||$_smarty_tpl->tpl_vars['product']->value->reference||(isset($_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)&&$_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)) {?>
                    <!-- add to cart form-->
                    <form id="buy_block"<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&!isset($_smarty_tpl->tpl_vars['groups']->value)&&$_smarty_tpl->tpl_vars['product']->value->quantity>0) {?> class="hidden"<?php }?>
...
<?php }?><?php }?><?php }?></span><?php }?></p>
 ...
 <span
                                                    style="text-decoration: line-through;"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value->getNoPackPrice()),$_smarty_tpl);?>
</span>
                                        </p>
                                    <?php }?>
 ...
 <span
                                                    id="ecotax_price_display"><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==2) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['convertAndFormatPrice'][0][0]->convertAndFormatPrice($_smarty_tpl->tpl_vars['ecotax_tax_exc']->value);?>
...
<?php }?></span> <?php echo smartyTranslate(array('s'=>'for ecotax'),$_smarty_tpl);?>
                                    ...
                                    <?php if (!empty($_smarty_tpl->tpl_vars['product']->value->unity)&&$_smarty_tpl->tpl_vars['product']->value->unit_price_ratio>0.000000) {?>
                                        ...
                                        <p class="unit-price"><span
                                                    id="unit_price_display"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['unit_price']->value),$_smarty_tpl);?>
...
<?php } else { ?>1<?php }?><?php }?>"/>
 ...
 <b
                                            id="minimal_quantity_label"><?php echo $_smarty_tpl->tpl_vars['product']->value->minimal_quantity;?>
</b>
                                </p>
                                            ...
                                            <?php if (count($_smarty_tpl->tpl_vars['group']->value['attributes'])) {?>
                                                <fieldset class="attribute_fieldset">
                                                    <label class="attribute_label"
                                                           <?php if ($_smarty_tpl->tpl_vars['group']->value['group_type']!='color'&&$_smarty_tpl->tpl_vars['group']->value['group_type']!='radio') {?>for="group_<?php echo intval($_smarty_tpl->tpl_vars['id_attribute_group']->value);?>
...
"<?php if ((isset($_GET[$_smarty_tpl->tpl_vars['groupName']->value])&&intval($_GET[$_smarty_tpl->tpl_vars['groupName']->value])==$_smarty_tpl->tpl_vars['id_attribute']->value)||$_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value) {?> selected="selected"<?php }?>
...
.jpg"
                                                                                     alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['name'], ENT_QUOTES, 'UTF-8', true);?>
"
                                                                                     title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['name'], ENT_QUOTES, 'UTF-8', true);?>
"
                                                                                     width="20" height="20"/>
...
<?php }?>
                ...
                <div class="testimonials_block">
                    <p>
                        ...
                        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayReview"),$_smarty_tpl);?>

                        <a href="#">Read more ></a>
                    </p>
                </div>
                <div class="product-shiping">
                    <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./product-shiping.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

                    
                    <?php echo smartyTranslate(array('s'=>'This %s Oil Painting reproduction masterpiece is hand painted by a real artist. No digital or printing techniques are used. You are commissioning a real painting.','sprintf'=>$_smarty_tpl->tpl_vars['category']->value->name),$_smarty_tpl);?>
        ...
        <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./free-shiping.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
"
                                                   class="product-image product_image">
                                                    <img class="lazyOwl"
                                                         src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['accessory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['accessory']->value['id_image'],'home_default'), ENT_QUOTES, 'UTF-8', true);?>
"
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['attachment']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
                                ...
                                <a class="btn btn-default btn-block"
                                   href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('attachment',true,null,"id_attachment=".((string)$_smarty_tpl->tpl_vars['attachment']->value['id_attachment'])), ENT_QUOTES, 'UTF-8', true);?>
">
...
icon/delete.gif"
                                                                     alt="<?php echo smartyTranslate(array('s'=>'Delete'),$_smarty_tpl);?>
"
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayViewedProducts'),$_smarty_tpl);?>

<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayRandomProducts'),$_smarty_tpl);?>
