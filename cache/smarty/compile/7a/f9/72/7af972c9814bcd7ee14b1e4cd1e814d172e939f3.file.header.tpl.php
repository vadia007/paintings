...
<?php /*%%SmartyHeaderCode:207153382455bf6fc16cbbf7-68848342%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '207153382455bf6fc16cbbf7-68848342',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55bf6fc17dc386_72583198',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55bf6fc17dc386_72583198')) {function content_55bf6fc17dc386_72583198($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/var/www/html/paintings.loc/tools/smarty/plugins/function.implode.php';
?>

<!DOCTYPE HTML>
<!--[if lt IE 7]>
<html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language_code']->value, ENT_QUOTES, 'UTF-8', true);?>
"><![endif]-->
<!--[if IE 7]>
<html class="no-js lt-ie9 lt-ie8 ie7" lang="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language_code']->value, ENT_QUOTES, 'UTF-8', true);?>
"><![endif]-->
<!--[if IE 8]>
<html class="no-js lt-ie9 ie8" lang="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language_code']->value, ENT_QUOTES, 'UTF-8', true);?>
"><![endif]-->
<!--[if gt IE 8]>
<html class="no-js ie9" lang="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language_code']->value, ENT_QUOTES, 'UTF-8', true);?>
"><![endif]-->
...
"></script>
    ...
    <link rel="stylesheet"
          href="http<?php if (Tools::usingSecureMode()) {?>s<?php }?>://fonts.googleapis.com/css?family=Open+Sans:300,600&amp;subset=latin,latin-ext"
                ...
                <div class="banner">
                    <div class="banner-content">
                        <div class="banner-content-line">
                            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayBannerContent"),$_smarty_tpl);?>

                        </div>
                        <div class="review-block">
                            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayFacebook'),$_smarty_tpl);?>

                        </div>
                        <div class="quality-block">
                            <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./banner-imgs.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
                ...
                <div class="search-line">
                    <div class="search-block">
                        <div class="search-content">
                            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displaySearchContent"),$_smarty_tpl);?>

                        </div>
                        <div class="categories-search-block">
                            <?php if (isset($_smarty_tpl->tpl_vars['HOOK_HOME_TAB']->value)&&trim($_smarty_tpl->tpl_vars['HOOK_HOME_TAB']->value)) {?>
                                <span class="search-for"><?php echo smartyTranslate(array('s'=>'SEARCH FOR:'),$_smarty_tpl);?>
</span>
                                <ul id="home-tabs">
                            ...
                            <?php }?>
                            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayProductCategories'),$_smarty_tpl);?>
        ...
        <div id="columns">
            ...
            <div class="row">
                <?php if (isset($_smarty_tpl->tpl_vars['left_column_size']->value)&&!empty($_smarty_tpl->tpl_vars['left_column_size']->value)) {?>
                    <div id="left_column"
                         class="column col-xs-12 col-sm-<?php echo intval($_smarty_tpl->tpl_vars['left_column_size']->value);?>
