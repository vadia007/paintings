...
class BlockNewProducts extends Module
{
	...
	public function install()
	{
		$success = (parent::install()
			...
			&& $this->registerHook('displayRandomProducts')
		);
	...
	public function hookDisplayRandomProducts() {
		$all_products = $this->getNewProducts();
		...
		if($all_products) {
			...
			for($i = 0; $i < 7; $i++) {
				...
				$random_products[] = $all_products[$rand];
			}
		}
		...
		return $this->display(__FILE__, 'blockrandomproducts.tpl');
	}
