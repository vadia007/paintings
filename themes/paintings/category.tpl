    ...
    {if $category->id AND $category->active}
            ...
            <div class="content_scene_cat">
                ...
                <div class="content_scene_cat_bg">
                    <div class="category-img">
                        <img src="{$link->getCatImageLink($category->link_rewrite, $category->id_image)|escape:'html':'UTF-8'}"
                             height="120" alt=""/>
                    </div>
                                ...
                                <div class="subcategory-image">
                                    <a href="{$link->getCategoryLink($subcategory.id_category, $subcategory.link_rewrite)|escape:'html':'UTF-8'}"
                                       title="{$subcategory.name|escape:'html':'UTF-8'}" class="img">
                                        ...
                                        {else}
                                            <img class="replace-2x"
                                                 src="{$img_cat_dir}{$lang_iso}-default-medium_default.jpg" alt=""
        ...
        <div class="product-pagination">
            ...
            {if $products}
                ...
                <div class="pagination-line" style="float: right">
