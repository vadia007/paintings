<div id="opc_new_account" class="opc-main-block">
	...
	<h1 class="page-heading step-num"><span>1</span> {l s='Personal details'}</h1>
			...
			<div class="box checkout-fields">
				...
				<div id="opc_account_form" class="unvisible">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control validate" id="fax" name="fax" value="{if isset($guestInformations) && isset($guestInformations.customer_fax) && $guestInformations.customer_fax}{$guestInformations.customer_fax}{/if}" />
					</div>
					<div class="form-group">
						<label for="details_website">{l s='Website'}</label>
						<input type="text" class="form-control validate" id="details_website" name="details_website" value="{if isset($guestInformations) && isset($guestInformations.customer_details_website) && $guestInformations.customer_details_website}{$guestInformations.customer_details_website}{/if}" />
					</div>
					...
					{*</div>*}
					{*{/if}*}
					<h3 class="page-subheading top-indent">{l s='Shipping Address'}</h3>
					{$stateExist = false}
					{$postCodeExist = false}
					{$dniExist = false}
					{foreach from=$dlv_all_fields item=field_name}
						...
						{elseif $field_name eq "fax"}
							<div class="text form-group">
								<label for="fax">{l s='Fax'}</label>
								<input type="text" class="text form-control validate" id="fax" name="fax" value="{if isset($guestInformations) && isset($guestInformations.fax) && $guestInformations.fax}{$guestInformations.fax}{/if}" />
							</div>
						{elseif $field_name eq "details_website"}
							<div class="text form-group">
								<label for="details_website">{l s='Website'}</label>
								<input type="text" class="text form-control validate" id="details_website" name="details_website" value="{if isset($guestInformations) && isset($guestInformations.details_website) && $guestInformations.details_website}{$guestInformations.details_website}{/if}" />
							</div>
					...
					<div id="opc_invoice_address" class="is_customer_param">
						...
						{foreach from=$inv_all_fields item=field_name}
							...
							{elseif $field_name eq "fax"}
								<div class="form-group">
									<label for="fax_invoice">{l s='Fax'}</label>
									<input type="text" class="form-control validate" id="fax_invoice" name="fax_invoice" value="{if isset($guestInformations) && isset($guestInformations.fax_invoice) && $guestInformations.fax_invoice}{$guestInformations.fax_invoice}{/if}" />
								</div>
							{elseif $field_name eq "details_website"}
								<div class="form-group">
									<label for="fax_invoice">{l s='Website'}</label>
									<input type="text" class="form-control validate" id="details_website_invoice" name="details_website_invoice" value="{if isset($guestInformations) && isset($guestInformations.details_website_invoice) && $guestInformations.details_website_invoice}{$guestInformations.details_website_invoice}{/if}" />
								</div>
							{elseif $field_name eq "address1"}
								<div class="required form-group">
